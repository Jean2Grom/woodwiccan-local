...
/**
 * @var WW\Module $this
 * @var WW\User\Profile $profile
 * @var WW\Website[] $websitesList
 * @var array $allSitesModulesList
 */
?>
<div    data-profile="<?=$profile->id?>"
        class="box edit__profile" >
   <form    class="edit-profile-form" 
            id="edit-profile-form-<?=$profile->id?>"  
            method="post" >
        <input  type="hidden" 
                value="<?=$profile->id ?>" 
                name="profile-id" />
            ...
            <tbody>
                ...
                <?php foreach( $profile->policies as $policy ): ?>
                    <tr class="policy-container">
                        ...
                        <td>
                            <button <?= $policy->positionId? 'style="display: none;"': '' ?>
                                    class="policy-witch">
                                <i class="fa fa-sitemap"></i>
                                Choose Witch
                            </button>
                            <a  <?= !$policy->positionId? 'style="display: none;"': '' ?>
                                href="<?= $this->ww->website->getUrl("view", [ 'id' => $policy->positionId ]) ?>"
                                class="policy-witch-display"
                                target="_blank">
                                <?= $policy->positionName? $policy->positionName: '' ?>
                            </a>
                            <a  <?= !$policy->positionId? 'style="display: none;"': '' ?>
                                class="unset-policy-witch">
                                <i class="fa fa-times"></i>
                            ...
                            <input  type="hidden" 
                                    value="<?= $policy->positionId? $policy->positionId: '' ?>" 
                                    data-init="<?= $policy->positionId ?>"
                                    name="policy-witch-id[]" 
                                    class="policy-witch-id" />
                        </td>
                        <td>
                            <ul <?= !$policy->positionId? 'style="display: none;"': '' ?>
                                class="policy-witch-set" >
                                <li>
                                    <input  type="checkbox" 
                                            name="policy-witch-rules-ancestors[]"
                                            value="<?= $policy->id ?>"
