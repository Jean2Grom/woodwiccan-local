        ...
        <div class="flex flex-col lg:flex-row">
            <div class="lg:w-1/2 mb-12 lg:mb-0 lg:pr-12">
                <h2 class="text-3xl md:text-4xl font-bold mb-6">
                    <?=$cauldron->content('reservation-headline') ?>
                </h2>
                <div class="w-24 h-1 bg-amber-500 mb-6"></div>
                <p class="text-gray-600 mb-8">
                    <?=$cauldron->content('reservation-description') ?>
                </p>
            ...
            <div class="lg:w-1/2 lg:pl-12">
                <h2 class="text-3xl md:text-4xl font-bold mb-6">
                    <?=$cauldron->content('contact-headline') ?>
                </h2>
                <div class="w-24 h-1 bg-amber-500 mb-6"></div>
                
                <div class="space-y-6 mb-8">

                    <?php foreach( $cauldron->bulletpoints->value() as $bulletpoint ): if( $bulletpoint->type === 'gh-bulletpoint' ): ?>
                        <div class="flex items-start">
                            <div class="bg-amber-100 p-3 rounded-full mr-4">
                                <i class="fas <?=$bulletpoint->icon_class ?> text-amber-500 text-xl"></i>
                            </div>
                            <div class="contact-bulletpoint-body text-gray-600">
